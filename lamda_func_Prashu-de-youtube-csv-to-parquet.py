...
print("Creating DynamicFrame from catalog")
...
## @type: DataSink
## @args: [connection_type = "s3", connection_options = {"path": "s3://prashu-de-youtube-cleansed-useast1-dev/youtube/raw_statistics/", "partitionKeys": ["region"]}, format = "parquet", transformation_ctx = "datasink4"]
## @return: datasink4
...
datasink4 = glueContext.write_dynamic_frame.from_options(
    ...
    connection_type="s3", 
    connection_options={"path": "s3://prashu-de-youtube-cleansed-useast1-dev/youtube/raw_statistics/", "partitionKeys": ["region"]}, 
    format="parquet", 
